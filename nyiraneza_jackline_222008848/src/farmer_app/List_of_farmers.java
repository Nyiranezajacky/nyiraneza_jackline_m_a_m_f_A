...
public class List_of_farmers extends JFrame {
...
public List_of_farmers() {
	...
	my_mysql obj=new my_mysql();
	 ...
	 JLabel titles=new JLabel("LIST OF  ALL FARMERS");
	 contentPane.add(titles);
	 titles.setBounds(10, 20, 300, 30);
		
	String[] column= {"farmersID","FirstName","LastName","Email"};
...
public List_of_farmers(DefaultTableModel defaultTableModel) {
...
try{  
	...
	"jdbc:mysql://localhost:3306/nyiraneza_jackline_mamf","222008848","222008848");  
	Statement st=con.createStatement();  
	
  ResultSet rs=st.executeQuery("SELECT * FROM farmers1"); 
